                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Author: DN Coffee</p>
                            <p>Linkedin: <a href="https://www.linkedin.com/feed/ target=" _blank"> Nghia Le </a></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 text-center     text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href=" target=" _blank"><i
                                    class="fas fa-copyright text-light me-2"></i>DN Coffee</a>, All right
                            reserved.</span>
                    </div>
